    ...
    const msg = {
		...
		<tbody>
			...
			<tr>
				...
				You have been provided a staff adminstration access to Trabahanap.com. Please click the button below to verify your email address and reset your password. By confirming your account, you will assume the admin staff privilege right away.
				</td>
			</tr>
			<tr>
				<td>
						...
						<tbody>
							<tr>
								<td style="padding-top:30px;padding-bottom:20px">
									...
									<a href="${constants.HOST_URL}/auth/new_staffer/${email}/${token}" style="box-sizing:border-box;border-color:#348eda;font-weight:400;text-decoration:none;display:inline-block;margin:0;color:#ffffff;background-color:#dd3806;border:solid 1px #348eda;border-radius:2px;font-size:14px;padding:12px 45px" target="_blank" >Accept Invitation</a>								</div>
						</tbody>
					</table>
				</td>
			</tr>
