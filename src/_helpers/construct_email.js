				                ...
				                <tbody>
				                    <tr>
					                    <td style="padding-top:30px;padding-bottom:20px">
						                    <h4>
							                    Click <a href="${process.env.HOST_URL}/auth/email_verification?token=${user.emailVerificationToken}&email=${user.email}" target="_blank">${process.env.HOST_URL}/verification?token=${user.emailVerificationToken}</a> to activate your account.
						                    </h4>
				                </tbody>
			                </table>
		                </td>
